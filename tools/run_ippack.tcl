...
set Library     "hls"
set IPName      "vit_transformer_layer_fused"
set Version     "1.0"
set DisplayName "Vit_transformer_layer_fused"
set Revision    "25"
...
set xo_kernel_name "vit_transformer_layer_fused"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "C:/Users/19571/Desktop/FPGA_ViT_Project/hls/vit_transformer_layer_fused_mlp256_prj/solution_unroll16"
set debug_dir "C:/Users/19571/Desktop/FPGA_ViT_Project/hls/vit_transformer_layer_fused_mlp256_prj/solution_unroll16/.debug"
set xo_hls_files_dir ""
set hdl_module_list {vit_transformer_layer_fused_fadd_32ns_32ns_32_4_no_dsp_1
vit_transformer_layer_fused_faddfsub_32ns_32ns_32_4_full_dsp_1
vit_transformer_layer_fused_fmul_32ns_32ns_32_3_max_dsp_1
vit_transformer_layer_fused_fcmp_32ns_32ns_1_2_no_dsp_1
vit_transformer_layer_fused_mux_1664_32_1_1
vit_transformer_layer_fused_fadd_32ns_32ns_32_4_full_dsp_1
vit_transformer_layer_fused_fdiv_32ns_32ns_32_12_no_dsp_1
vit_transformer_layer_fused_mux_42_32_1_1
vit_transformer_layer_fused_token_0
vit_transformer_layer_fused_qkv_0
vit_transformer_layer_fused_attn_prob
vit_transformer_layer_fused_mlp_hidden_0
vit_transformer_layer_fused_qkv_weight_cache_0
vit_transformer_layer_fused_fc2_weight_row_0
vit_transformer_layer_fused_control_s_axi
vit_transformer_layer_fused_gmem_token_m_axi
vit_transformer_layer_fused_gmem_param_m_axi
vit_transformer_layer_fused_gmem_qkvw_m_axi
vit_transformer_layer_fused_gmem_attnw_m_axi
vit_transformer_layer_fused_gmem_mlpw_m_axi
vit_transformer_layer_fused_gmem_out_m_axi
layer_norm_fused
...
## Variables
set Top "vit_transformer_layer_fused"
set TopNoPrefix "vit_transformer_layer_fused"
...
set Interfaces {
    s_axi_control {
        ...
        registers {{0x00 CTRL       RW   0x0 "Control signals" {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }}} {0x04 GIER       RW   0x0 "Global Interrupt Enable Register" {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }} } {0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register" {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register" {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x10 token_in_1 W 0x0 "Data signal of token_in" {{0 32 token_in W 0 "Bit 31 to 0 of token_in"}}} {0x14 token_in_2 W 0x0 "Data signal of token_in" {{0 32 token_in W 0 "Bit 63 to 32 of token_in"}}} {0x1c norm1_w_1 W 0x0 "Data signal of norm1_w" {{0 32 norm1_w W 0 "Bit 31 to 0 of norm1_w"}}} {0x20 norm1_w_2 W 0x0 "Data signal of norm1_w" {{0 32 norm1_w W 0 "Bit 63 to 32 of norm1_w"}}} {0x28 norm1_b_1 W 0x0 "Data signal of norm1_b" {{0 32 norm1_b W 0 "Bit 31 to 0 of norm1_b"}}} {0x2c norm1_b_2 W 0x0 "Data signal of norm1_b" {{0 32 norm1_b W 0 "Bit 63 to 32 of norm1_b"}}} {0x34 qkv_w_1 W 0x0 "Data signal of qkv_w" {{0 32 qkv_w W 0 "Bit 31 to 0 of qkv_w"}}} {0x38 qkv_w_2 W 0x0 "Data signal of qkv_w" {{0 32 qkv_w W 0 "Bit 63 to 32 of qkv_w"}}} {0x40 qkv_b_1 W 0x0 "Data signal of qkv_b" {{0 32 qkv_b W 0 "Bit 31 to 0 of qkv_b"}}} {0x44 qkv_b_2 W 0x0 "Data signal of qkv_b" {{0 32 qkv_b W 0 "Bit 63 to 32 of qkv_b"}}} {0x4c attn_proj_w_1 W 0x0 "Data signal of attn_proj_w" {{0 32 attn_proj_w W 0 "Bit 31 to 0 of attn_proj_w"}}} {0x50 attn_proj_w_2 W 0x0 "Data signal of attn_proj_w" {{0 32 attn_proj_w W 0 "Bit 63 to 32 of attn_proj_w"}}} {0x58 attn_proj_b_1 W 0x0 "Data signal of attn_proj_b" {{0 32 attn_proj_b W 0 "Bit 31 to 0 of attn_proj_b"}}} {0x5c attn_proj_b_2 W 0x0 "Data signal of attn_proj_b" {{0 32 attn_proj_b W 0 "Bit 63 to 32 of attn_proj_b"}}} {0x64 norm2_w_1 W 0x0 "Data signal of norm2_w" {{0 32 norm2_w W 0 "Bit 31 to 0 of norm2_w"}}} {0x68 norm2_w_2 W 0x0 "Data signal of norm2_w" {{0 32 norm2_w W 0 "Bit 63 to 32 of norm2_w"}}} {0x70 norm2_b_1 W 0x0 "Data signal of norm2_b" {{0 32 norm2_b W 0 "Bit 31 to 0 of norm2_b"}}} {0x74 norm2_b_2 W 0x0 "Data signal of norm2_b" {{0 32 norm2_b W 0 "Bit 63 to 32 of norm2_b"}}} {0x7c fc1_w_1 W 0x0 "Data signal of fc1_w" {{0 32 fc1_w W 0 "Bit 31 to 0 of fc1_w"}}} {0x80 fc1_w_2 W 0x0 "Data signal of fc1_w" {{0 32 fc1_w W 0 "Bit 63 to 32 of fc1_w"}}} {0x88 fc1_b_1 W 0x0 "Data signal of fc1_b" {{0 32 fc1_b W 0 "Bit 31 to 0 of fc1_b"}}} {0x8c fc1_b_2 W 0x0 "Data signal of fc1_b" {{0 32 fc1_b W 0 "Bit 63 to 32 of fc1_b"}}} {0x94 gelu_lut_1 W 0x0 "Data signal of gelu_lut" {{0 32 gelu_lut W 0 "Bit 31 to 0 of gelu_lut"}}} {0x98 gelu_lut_2 W 0x0 "Data signal of gelu_lut" {{0 32 gelu_lut W 0 "Bit 63 to 32 of gelu_lut"}}} {0xa0 fc2_w_1 W 0x0 "Data signal of fc2_w" {{0 32 fc2_w W 0 "Bit 31 to 0 of fc2_w"}}} {0xa4 fc2_w_2 W 0x0 "Data signal of fc2_w" {{0 32 fc2_w W 0 "Bit 63 to 32 of fc2_w"}}} {0xac fc2_b_1 W 0x0 "Data signal of fc2_b" {{0 32 fc2_b W 0 "Bit 31 to 0 of fc2_b"}}} {0xb0 fc2_b_2 W 0x0 "Data signal of fc2_b" {{0 32 fc2_b W 0 "Bit 63 to 32 of fc2_b"}}} {0xb8 token_out_1 W 0x0 "Data signal of token_out" {{0 32 token_out W 0 "Bit 31 to 0 of token_out"}}} {0xbc token_out_2 W 0x0 "Data signal of token_out" {{0 32 token_out W 0 "Bit 63 to 32 of token_out"}}} {0xc4 qkv_w_scale W 0x0 "Data signal of qkv_w_scale" {{0 32 qkv_w_scale W 0 "Bit 31 to 0 of qkv_w_scale"}}} {0xcc attn_proj_w_scale W 0x0 "Data signal of attn_proj_w_scale" {{0 32 attn_proj_w_scale W 0 "Bit 31 to 0 of attn_proj_w_scale"}}} {0xd4 fc1_w_scale W 0x0 "Data signal of fc1_w_scale" {{0 32 fc1_w_scale W 0 "Bit 31 to 0 of fc1_w_scale"}}} {0xdc fc2_w_scale W 0x0 "Data signal of fc2_w_scale" {{0 32 fc2_w_scale W 0 "Bit 31 to 0 of fc2_w_scale"}}} {0xe4 hidden_inv_scale W 0x0 "Data signal of hidden_inv_scale" {{0 32 hidden_inv_scale W 0 "Bit 31 to 0 of hidden_inv_scale"}}} {0xec lut_min W 0x0 "Data signal of lut_min" {{0 32 lut_min W 0 "Bit 31 to 0 of lut_min"}}} {0xf4 lut_index_scale W 0x0 "Data signal of lut_index_scale" {{0 32 lut_index_scale W 0 "Bit 31 to 0 of lut_index_scale"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_control m_axi_gmem_token m_axi_gmem_param m_axi_gmem_qkvw m_axi_gmem_attnw m_axi_gmem_mlpw m_axi_gmem_out"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    m_axi_gmem_token {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_gmem_token"
        data_width "32"
        param_prefix "C_M_AXI_GMEM_TOKEN"
    ...
    m_axi_gmem_param {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_gmem_param"
        data_width "32"
        param_prefix "C_M_AXI_GMEM_PARAM"
        port_width "AWADDR 64 AWID 1 AWUSER 1 WDATA 32 WSTRB 4 WID 1 WUSER 1 ARADDR 64 ARID 1 ARUSER 1 RDATA 32 RID 1 RUSER 1 BID 1 BUSER 1"
        ctype {
            AWLEN {
                Type "integer unsigned"
    ...
    m_axi_gmem_qkvw {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_gmem_qkvw"
        data_width "32"
        param_prefix "C_M_AXI_GMEM_QKVW"
        port_width "AWADDR 64 AWID 1 AWUSER 1 WDATA 32 WSTRB 4 WID 1 WUSER 1 ARADDR 64 ARID 1 ARUSER 1 RDATA 32 RID 1 RUSER 1 BID 1 BUSER 1"
        ctype {
            AWLEN {
                Type "integer unsigned"
    ...
    m_axi_gmem_attnw {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_gmem_attnw"
        data_width "32"
        param_prefix "C_M_AXI_GMEM_ATTNW"
        port_width "AWADDR 64 AWID 1 AWUSER 1 WDATA 32 WSTRB 4 WID 1 WUSER 1 ARADDR 64 ARID 1 ARUSER 1 RDATA 32 RID 1 RUSER 1 BID 1 BUSER 1"
        ctype {
            AWLEN {
                Type "integer unsigned"
    ...
    m_axi_gmem_mlpw {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_gmem_mlpw"
        data_width "32"
        param_prefix "C_M_AXI_GMEM_MLPW"
        port_width "AWADDR 64 AWID 1 AWUSER 1 WDATA 32 WSTRB 4 WID 1 WUSER 1 ARADDR 64 ARID 1 ARUSER 1 RDATA 32 RID 1 RUSER 1 BID 1 BUSER 1"
        ctype {
            AWLEN {
                Type "integer unsigned"
...
## System Info
set user_parameters_list {clk_period 16 machine 64 combinational 0 latency 628137 II x}
...
source -notrace "D:/fpga/Vitis/2020.1/common/scripts/ipxhls.tcl"
